...
from utilities import load_data, show_timetable, set_up, write_solution_to_file
        ...
        while True:
            ...
            if found:
                for group_index in classs.groups:
                    ...
                    insert_order(subjects_order, classs.subject, group_index, start_time)
...
def insert_order(subjects_order, subject, group, start_time):
    """
